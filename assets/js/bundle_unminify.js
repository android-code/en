function toggleMobileNav() {
    $(".header__toggle").click(function() {
        $(".header__links").hasClass("js--open") ? hideMobileNav() : openMobileNav()
...
! function(e, t) {
    ...
    function h(e) {
        var t, n = e.ownerDocument,
            r = e.nodeName,
            i = Ve[r];
        return i || (t = n.body.appendChild(n.createElement(r)), i = se.css(t, "display"), t.parentNode.removeChild(t), "none" === i && (i = "block"), Ve[r] = i, i)
    }
    ...
    function v(e, t, n, r, i) {
        for (var o, a, s, l, u, c, f = t.createDocumentFragment(), d = [], p = 0, h = e.length; p < h; p++)
            ...
            for (a = a || f.appendChild(t.createElement("div")), s = (ze.exec(o) || ["", ""])[1].toLowerCase(), l = Re[s] || Re._default, a.innerHTML = l[1] + se.htmlPrefilter(o) + l[2], c = l[0]; c--;) a = a.lastChild;
        ...
        for (f.textContent = "", p = 0; o = d[p++];)
            ...
            for (c = 0; o = a[c++];) Oe.test(o.type || "") && n.push(o);
        return f
    }
    ...
    function E(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            Ne.hasData(e) && (s = Ne.access(e), l = se.extend({}, s), Ne.set(t, l))
        }
    }
    ...
    function N(e, t, r, i) {
        ...
        if (d && (o = v(t, e[0].ownerDocument, !1, e, i), a = o.firstChild, 1 === o.childNodes.length && (o = a), a || i)) {
            ...
            if (l)
                for (c = s[s.length - 1].ownerDocument, se.map(s, k), f = 0; f < l; f++) u = s[f], Oe.test(u.type || "") && !Ae.access(u, "globalEval") && se.contains(c, u) && (u.src ? se._evalUrl && se._evalUrl(u.src) : n(u.textContent.replace(Qe, ""), c))
        }
        return e
    }
    ...
    function $() {
        st && (!1 === G.hidden && e.requestAnimationFrame ? e.requestAnimationFrame($) : e.setTimeout($, se.fx.interval), se.fx.tick())
    }
    ...
    function M(e, t, n) {
        var r, i, o = 0,
            ...
            l = function() {
                if (i) return !1;
                for (var t = at || z(), n = Math.max(0, u.startTime + u.duration - t), r = 1 - (n / u.duration || 0), o = 0, a = u.tweens.length; o < a; o++) u.tweens[o].run(r);
    ...
    var de = function(e) {
        function t(e, t, n, r) {
            ...
            if (!r && ((t ? t.ownerDocument || t : O) !== L && j(t), t = t || L, F)) {
                if (11 !== h && (l = ge.exec(e)))
                    if (i = l[1]) {
                        if (9 === h) {
                ...
                if (x.qsa && !I[e + " "] && (!D || !D.test(e))) {
                    if (1 !== h) d = t, c = e;
                        ...
                        for ((s = t.getAttribute("id")) ? s = s.replace(be, xe) : t.setAttribute("id", s = z), o = (u = S(e)).length; o--;) u[o] = "#" + s + " " + p(u[o]);
        ...
        function h(e, t, n) {
            ...
            return t.first ? function(t, n, i) {
                ...
                if (l) {
                    ...
                    for (; t = t[r];)
                        if (1 === t.nodeType || a)
                            if (f = t[z] || (t[z] = {}), c = f[t.uniqueID] || (f[t.uniqueID] = {}), i && i === t.nodeName.toLowerCase()) t = t[r] || t;
                            else {
        ...
        function y(e, n, i, o, a, s) {
            return o && !o[z] && (o = y(o)), a && !a[z] && (a = y(a, s)), r(function(r, s, l, u) {
                var c, f, d, p = [],
                    h = [],
                    g = s.length,
                    y = r || function(e, n, r) {
        ...
        function v(e) {
            for (var t, n, r, i = e.length, o = w.relative[e[0].type], a = o || w.relative[" "], s = o ? 1 : 0, l = h(function(e) {
                ...
                if (n = w.relative[e[s].type]) c = [h(g(c), n)];
                    ...
                    if ((n = w.filter[e[s].type].apply(null, e[s].matches))[z]) {
        ...
        var b, x, w, C, T, S, k, E, A, N, P, j, L, q, F, D, H, V, $, z = "sizzle" + 1 * new Date,
            O = e.document,
            R = 0,
            M = 0,
            _ = n(),
        ...
        try {
            Q.apply(U = J.call(O.childNodes), O.childNodes), U[O.childNodes.length].nodeType
        } catch (e) {
            Q = {
        ...
        x = t.support = {}, T = t.isXML = function(e) {
            ...
            return r !== L && 9 === r.nodeType && r.documentElement ? (L = r, q = L.documentElement, F = !T(L), O !== L && (n = L.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", we, !1) : n.attachEvent && n.attachEvent("onunload", we)), x.attributes = i(function(e) {
                return e.className = "i", !e.getAttribute("className")
            }), x.getElementsByTagName = i(function(e) {
                return e.appendChild(L.createComment("")), !e.getElementsByTagName("*").length
            }), x.getElementsByClassName = he.test(L.getElementsByClassName), x.getById = i(function(e) {
                return q.appendChild(e).id = z, !L.getElementsByName || !L.getElementsByName(z).length
                ...
                q.appendChild(e).innerHTML = "<a id='" + z + "'></a><select id='" + z + "-\r\\' msallowcapture=''><option selected=''></option></select>", e.querySelectorAll("[msallowcapture^='']").length && D.push("[*^$]=" + ee + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || D.push("\\[" + ee + "*(?:value|" + K + ")"), e.querySelectorAll("[id~=" + z + "-]").length || D.push("~="), e.querySelectorAll(":checked").length || D.push(":checked"), e.querySelectorAll("a#" + z + "+*").length || D.push(".#.+[+~]")
            }), i(function(e) {
            ...
            })), (x.matchesSelector = he.test(V = q.matches || q.webkitMatchesSelector || q.mozMatchesSelector || q.oMatchesSelector || q.msMatchesSelector)) && i(function(e) {
                x.disconnectedMatch = V.call(e, "*"), V.call(e, "[s!='']:x"), H.push("!=", re)
            }), D = D.length && new RegExp(D.join("|")), H = H.length && new RegExp(H.join("|")), t = he.test(q.compareDocumentPosition), $ = t || he.test(q.contains) ? function(e, t) {
                ...
                return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !x.sortDetached && t.compareDocumentPosition(e) === n ? e === L || e.ownerDocument === O && $(O, e) ? -1 : t === L || t.ownerDocument === O && $(O, t) ? 1 : N ? Z(N, e) - Z(N, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return P = !0, 0;
                var n, r = 0,
                    i = e.parentNode,
            ...
            var t, n = [],
                r = 0,
                i = 0;
            if (P = !x.detectDuplicates, N = !x.sortStable && e.slice(0), e.sort(B), P) {
            ...
            filter: {
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (h = [a ? m.firstChild : m.lastChild], a && v) {
                                for (b = (p = (u = (c = (f = (d = m)[z] || (d[z] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === R && u[1]) && u[2], d = p && m.childNodes[p]; d = ++p && d && d[g] || (b = p = 0) || h.pop();)
                                    if (1 === d.nodeType && ++b && d === t) {
                                        c[e] = [R, p, b];
                                        break
                                    }
                            } else if (v && (b = p = (u = (c = (f = (d = t)[z] || (d[z] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] || [])[0] === R && u[1]), !1 === b)
                                for (;
                                    (d = ++p && d && d[g] || (b = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== y : 1 !== d.nodeType) || !++b || (v && ((c = (f = d[z] || (d[z] = {}))[d.uniqueID] || (f[d.uniqueID] = {}))[e] = [R, b]), d !== t)););
                ...
                PSEUDO: function(e, n) {
                    ...
                    return o[z] ? o(n) : o.length > 1 ? (i = [e, e, "", n], w.setFilters.hasOwnProperty(e.toLowerCase()) ? r(function(e, t) {
        ...
        return d.prototype = w.filters = w.pseudos, w.setFilters = new d, S = t.tokenize = function(e, n) {
            ...
            var i, o = [],
                ...
                s = I[e + " "];
            if (!s) {
                for (n || (n = S(e)), i = n.length; i--;)(s = v(n[i]))[z] ? o.push(s) : a.push(s);
                (s = I(e, function(e, n) {
                    var i = n.length > 0,
                        o = e.length > 0,
        ...
        }, x.sortStable = z.split("").sort(B).join("") === z, x.detectDuplicates = !!P, j(), x.sortDetached = i(function(e) {
    ...
    se.extend({
        ...
        data: function(e, t) {
            var n, r, i, o = this[0],
                a = o && o.attributes;
            if (void 0 === e) {
                if (this.length && (i = Ne.get(o), 1 === o.nodeType && !Ae.get(o, "hasDataAttrs"))) {
    ...
    se.extend({
        ...
        html: function(e) {
            return ke(this, function(e) {
                ...
                if ("string" == typeof e && !Ue.test(e) && !Re[(ze.exec(e) || ["", ""])[1].toLowerCase()]) {
    ...
    }).init.prototype = V.prototype, (V.propHooks = {
        _default: {
            get: function(e) {
                var t;
    ...
    se.param = function(e, t) {
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !se(this).is(":disabled") && Ct.test(this.nodeName) && !wt.test(e) && (this.checked || !$e.test(e))
            }).map(function(e, t) {
                var n = se(this).val();
    ...
    qt.href = mt.href, se.extend({
        ...
        ajax: function(t, n) {
            ...
            if (y.promise(T), h.url = ((t || h.url || mt.href) + "").replace(Nt, mt.protocol + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(Ce) || [""], null == h.crossDomain) {
                u = G.createElement("a");
                try {
            ...
            if (h.data && h.processData && "string" != typeof h.data && (h.data = se.param(h.data, h.traditional)), X(Pt, h, n, T), c) return T;
    ...
    se.ajaxSetup({
        ...
        if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = se.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Vt, "$1" + i) : !1 !== t.jsonp && (t.url += (vt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
    ...
    return se.noConflict = function(t) {
        return e.$ === se && (e.$ = zt), t && e.jQuery === se && (e.jQuery = $t), se
    }, t || (e.jQuery = e.$ = se), se
}),
function(e, t) {
    var n = function() {
...
function(e, t) {
    var n = function(e, t) {
        ...
        var A = function() {
                var a, u, c, d, p, C, A, P, j, L, q, F, D, H, V = /^img$/i,
                    $ = /^iframe$/i,
                    ...
                    W = function(e, n) {
                        ...
                        for (P -= n, q += n, j -= n, L += n; a && (o = o.offsetParent) && o != t.body && o != i;)(a = (w(o, "opacity") || 1) > 0) && "visible" != w(o, "overflow") && (r = o.getBoundingClientRect(), a = L > r.left && j < r.right && q > r.top - 1 && P < r.bottom + 1);
                        return a
                    },
                    I = function() {
                        var e, o, s, l, c, f, p, h, g, m = n.elements;
                        if ((d = r.loadMode) && R < 8 && (e = m.length)) {
                            o = 0, M++, null == D && ("expand" in r || (r.expand = i.clientHeight > 500 && i.clientWidth > 500 ? 500 : 370), F = r.expand, D = F * r.expFactor), O < D && R < 1 && M > 2 && d > 2 && !t.hidden ? (O = D, M = 0) : O = d > 1 && M > 1 && R < 6 ? F : 0;
                            for (; o < e; o++)
                                if (m[o] && !m[o]._lazyRace)
                                    if (z)
                                        if ((h = m[o].getAttribute("data-expand")) && (f = 1 * h) || (f = O), g !== f && (C = innerWidth + f * H, A = innerHeight + f, p = -1 * f, g = f), s = m[o].getBoundingClientRect(), (q = s.bottom) >= p && (P = s.top) <= A && (L = s.right) >= p * H && (j = s.left) <= C && (q || L || j || P) && (r.loadHidden || "hidden" != w(m[o], "visibility")) && (u && R < 3 && !h && (d < 3 || M < 4) || W(m[o], f))) {
                                            if (J(m[o]), c = !0, R > 9) break
                                        } else !c && u && !l && R < 4 && M < 4 && d > 2 && (a[0] || r.preloadAfterLoad) && (a[0] || !h && (q || L || j || P || "auto" != m[o].getAttribute(r.sizesAttr))) && (l = a[0] || m[o]);
                            else J(m[o]);
                            l && !c && J(l)
                        }
                    },
                    ...
                    Q = S(function(e, t, n, i, o) {
                        ...
                        (p = b(e, "lazybeforeunveil", t)).defaultPrevented || (i && (n ? m(e, r.autosizesClass) : e.setAttribute("sizes", i)), s = e.getAttribute(r.srcsetAttr), a = e.getAttribute(r.srcAttr), o && (u = e.parentNode, d = u && f.test(u.nodeName || "")), g = t.firesLoad || "src" in e && (s || a || d), p = {
                            target: e
                        }, g && (v(e, _, !0), clearTimeout(c), c = l(_, 2500), m(e, r.loadingClass), v(e, Y, !0)), d && h.call(u.getElementsByTagName("source"), G), s ? e.setAttribute("srcset", s) : a && !d && ($.test(e.nodeName) ? function(e, t) {
                            try {
                    ...
                    J = function(e) {
                        var t, n = V.test(e.nodeName),
                            ...
                            o = "auto" == i;
                        (!o && u || !n || !e.getAttribute("src") && !e.srcset || e.complete || g(e, r.errorClass) || !g(e, r.lazyClass)) && (t = b(e, "lazyunveilread").detail, o && N.updateElem(e, !0, e.offsetWidth), e._lazyRace = !0, R++, Q(e, t, o, i, n))
                    },
                    Z = function() {
                        if (!u)
                    ...
                    if (C.State.calls[i]) {
                        ...
                        for (var x = Math.min(b / l.duration, 1), w = 0, T = s.length; w < T; w++) {
                            ...
                            if (o(A)) {
                                ...
                                for (var P in k)
                                    if (k.hasOwnProperty(P) && "element" !== P) {
                                        var j, L = k[P],
                                        ...
                                        if (L.currentValue = j, "tween" === P) m = j;
                                            ...
                                            var H;
                                            if (S.Hooks.registered[P]) {
                                                H = S.Hooks.getRoot(P);
                                                var V = o(A).rootPropertyValueCache[H];
                                                V && (L.rootPropertyValue = V)
                                            }
                                            var $ = S.setPropertyValue(A, P, L.currentValue + (p < 9 && 0 === parseFloat(j) ? "" : L.unitType), L.rootPropertyValue, L.scrollData);
                                            S.Hooks.registered[P] && (S.Normalizations.registered[H] ? o(A).rootPropertyValueCache[H] = S.Normalizations.registered[H]("extract", null, $[1]) : o(A).rootPropertyValueCache[H] = $[1]), "transform" === $[0] && (N = !0)
                                        }
                                    }
                                l.mobileHA && o(A).transformCache.translate3d === r && (o(A).transformCache.translate3d = "(0px, 0px, 0px)", N = !0), N && S.flushTransformCache(A)
                            }
                        }
            ...
            var k = function() {
                ...
                if (p && C.Promise && (E.promise = new C.Promise(function(e, t) {
                    ...
                    if (!/^(stop|finish|finishAll|pause|resume)$/i.test(b) && !d.isPlainObject(w)) {
                        w = {};
                        for (var P = g + 1; P < arguments.length; P++) v.isArray(arguments[P]) || !/^(fast|normal|slow)$/i.test(arguments[P]) && !/^\d/.test(arguments[P]) ? v.isString(arguments[P]) || v.isArray(arguments[P]) ? w.easing = arguments[P] : v.isFunction(arguments[P]) && (w.complete = arguments[P]) : w.duration = arguments[P]
                    }
                    var j;
                    switch (b) {
                        case "scroll":
                        ...
                        v.isNode(i) && function(e, i) {
                            function a(a) {
                                ...
                                if ("scroll" === j) {
                                    ...
                                    l.container ? v.isWrapped(l.container) || v.isNode(l.container) ? (l.container = l.container[0] || l.container, T = (g = l.container["scroll" + k]) + d(e).position()[k.toLowerCase()] + P) : l.container = null : (g = C.State.scrollAnchor[C.State["scrollProperty" + k]], x = C.State.scrollAnchor[C.State["scrollProperty" + ("Left" === k ? "Top" : "Left")]], T = d(e).offset()[k.toLowerCase()] + P), f = {
                                        scroll: {
                                            rootPropertyValue: !1,
                                            startValue: g,
                                            currentValue: g,
                                                ...
                                                if (y !== g && v.isString(y) && v.isString(g)) {
                                                    ...
                                                    for (y = S.Hooks.fixColors(y), g = S.Hooks.fixColors(g); E < y.length && A < g.length;) {
                                                        ...
                                                        if (/[\d\.-]/.test(F) && /[\d\.-]/.test(D)) {
                                                            ...
                                                            if (E += R.length, A += M.length, R === M) H === $ ? a += H + R : (a += "{" + N.length + (L ? "!" : "") + "}" + R, N.push(parseFloat(H)), P.push(parseFloat($)));
                                                            else {
                                                                var _ = parseFloat(H),
                                                                    W = parseFloat($);
                                                                a += (j < 5 ? "calc" : "") + "(" + (_ ? "{" + N.length + (L ? "!" : "") + "}" : "0") + R + " + " + (W ? "{" + (N.length + (_ ? 1 : 0)) + (L ? "!" : "") + "}" : "0") + M + ")", _ && (N.push(_), P.push(0)), W && (N.push(0), P.push(W))
                                                            }
                                                        } else {
                                                            if (F !== D) {
                                                                j = 0;
                                                    ...
                                                    E === y.length && A === g.length || (C.debug && console.error('Trying to pattern match mis-matched strings ["' + g + '", "' + y + '"]'), a = r), a && (N.length ? (C.debug && console.log('Pattern found "' + a + '" -> ', N, P, "[" + y + "," + g + "]"), y = N, g = P, x = w = "") : a = r)
                                                }
                                                if (a || (y = (b = k(i, y))[0], w = b[1], g = (b = k(i, g))[0].replace(/^([+-\/*])=/, function(e, t) {
                                                    ...
                                                    if (0 === g) x = w;
                                                        ...
                                                        s = s || function() {
                                                            ...
                                                            return null === V.remToPx && (V.remToPx = parseFloat(S.getPropertyValue(n.body, "fontSize")) || 16), null === V.vwToPx && (V.vwToPx = parseFloat(t.innerWidth) / 100, V.vhToPx = parseFloat(t.innerHeight) / 100), a.remToPx = V.remToPx, a.vwToPx = V.vwToPx, a.vhToPx = V.vhToPx, C.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(a), e), a
                                                        }();
                                    ...
                                    for (var H in b)
                                        if (b.hasOwnProperty(H)) {
                                            var z = S.Names.camelCase(H),
                                                O = F(b[H]);
                                            if (y(S.Lists.colors, z)) {
                                                var R = O[0],
                                                    M = O[1],
                                                    _ = O[2];
                                                if (S.RegEx.isHex.test(R)) {
                                                    for (var W = ["Red", "Green", "Blue"], I = S.Values.hexToRgb(R), B = _ ? S.Values.hexToRgb(_) : r, X = 0; X < W.length; X++) {
                                                        var U = [I[X]];
                                                        M && U.push(M), B !== r && U.push(B[X]), D(z + W[X], U)
                                                    }
                                                    continue
                                                }
                                            }
                                ...
                                f.element && (S.Values.addClass(e, "velocity-animating"), $.push(f), (p = o(e)) && ("" === l.queue && (p.tweensContainer = f, p.opts = l), p.isAnimating = !0), N === A - 1 ? (C.State.calls.push([$, m, l, null, E.resolver, null, 0]), !1 === C.State.isTicking && (C.State.isTicking = !0, c())) : N++)
                            }
                    ...
                    if (l.loop)
                        for (var O = 0; O < z; O++) {
                            ...
                            O === z - 1 && (R.display = l.display, R.visibility = l.visibility, R.complete = l.complete), k(m, "reverse", R)
                        }
                    return e()
                }
